...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 19, vars: 3, consts: [[1, "navbar", "navbar-dark", "bg-dark"], [1, "navbar-brand"], [1, "container", "mt-4"], [3, "formGroup", "ngSubmit"], [1, "row"], [1, "col-md-6"], ["type", "text", "formControlName", "description", 1, "form-control"], [1, "col-md-2"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], [1, "col-md-7"], [1, "list-group"], ["class", "list-group-item d-flex justify-content-between align-items-center", 4, "ngFor", "ngForOf"], [1, "list-group-item", "d-flex", "justify-content-between", "align-items-center"], [1, "btn-group"], [1, "btn", "btn-success", 3, "disabled", "click"], [1, "btn", "btn-danger", 3, "click"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! C:\Softwares\Java - Angular\ws-angular\front-end\src\main.ts */"./src/main.ts");
